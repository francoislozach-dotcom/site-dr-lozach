  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "tag": "Genou",
        "principe": "La greffe cartilagineuse autologue peut être envisagée pour certaines lésions localisées après examen et imagerie. Son indication dépend des caractéristiques de la lésion et de l’état de l’articulation.",
        "deroulement": "La technique utilise le cartilage du patient au cours de la même intervention. L’anesthésie, la durée opératoire et le séjour sont précisés individuellement en tenant compte des gestes associés.",
        "suites": "L’appui, les cannes ou l’attelle, la rééducation et la reprise des activités suivent les consignes individuelles du chirurgien. La page Greffe présente les étapes et les limites de cette prise en charge."
      },
      {
...
function InterventionsHero() {
  ...
  }, /*#__PURE__*/React.createElement("h1", {className: "eyebrow page-topic"}, "Chirurgie orthopédique à Sète"), /*#__PURE__*/React.createElement("div", {
    className: "line-mask"
